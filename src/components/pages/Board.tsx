    ...
    <div className="bg-bg-primary min-h-screen">
      ...
      <section className="relative h-72 bg-navy flex items-center justify-center overflow-hidden border-b border-navy-light">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-3 overflow-hidden">
          ...
          <h1 className="font-display text-2xl sm:text-4xl md:text-5xl font-light text-white tracking-tight break-words whitespace-normal leading-tight">
            Board of <span className="font-serif italic text-gold font-normal">Governors & Directors</span>
          </h1>
